						...
						<?php $counter=1; foreach( $lists as $list ):?>
							...
							<td><?php echo $counter;?></td>
								...
								<?php elseif($list->isactive==1 ):?>
									<a href="<?php echo adminsbase_url("dashboard/golestatus/0/$list->autoid/gole"); ?>" onclick="return confirm('Are you sure  want to start')" ><button type="button" class="btn btn-success">Start</button></a>
									<?php else:?>
							

									<a href="<?php echo adminsbase_url("dashboard/golestatus/1/$list->autoid/gole"); ?>" onclick="return confirm('Are you sure  want to stop')" ><button type="button" class="btn btn-danger">End</button></a>
								<?php endif;?>&nbsp;
								</td>
								<td>
